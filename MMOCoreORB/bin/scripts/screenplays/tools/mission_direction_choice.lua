...
--[[
	directions = {
		{dirDesc = "Reset", dirSelect = 0},
		{dirDesc = "N", dirSelect = 360},
		{dirDesc = "NW", dirSelect = 45},
		{dirDesc = "W", dirSelect = 90}, 
		{dirDesc = "SW", dirSelect = 135}, 
		{dirDesc = "S", dirSelect = 180}, 
		{dirDesc = "SE", dirSelect = 225}, 
		{dirDesc = "E", dirSelect = 270}, 
		{dirDesc = "NE", dirSelect = 315}, 
	}
]]
	directions = {
		{dirDesc = "Reset", dirSelect = 0},
		{dirDesc = "N", dirSelect = 180}, 
		{dirDesc = "NE", dirSelect = 135}, 
		{dirDesc = "NW", dirSelect = 225}, 
		{dirDesc = "E", dirSelect = 90}, 
		{dirDesc = "S", dirSelect = 360},
		{dirDesc = "SE", dirSelect = 45},
		{dirDesc = "SW", dirSelect = 315}, 
		{dirDesc = "W", dirSelect = 270}, 
	}
}
